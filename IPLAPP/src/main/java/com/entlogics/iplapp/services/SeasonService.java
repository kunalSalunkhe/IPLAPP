...
>>>>>>> 20b15f2328b8f943691cfd1ba8a2bb86f84b5d36
	}
	 ...
	 * System.out.println("Creating Database....");
	 * 
	 * // Creating Season Objects Season s1 = new Season(1, "season1", 2019); Season
	 * s2 = new Season(2, "season2", 2020); Season s3 = new Season(3, "season3",
	 * 2021);
	 * 
	 * // adding Players in Season Objects for that Creating PlayerSeason Objects
	 * Player p1 = new Player(1, "Dhoni", "WicketKeepar"); Player p2 = new Player(2,
	 * "Kohli", "Batsman"); Player p3 = new Player(3, "Bumrah", "Bowler");
	 * 
	 * PlayerSeason ps1 = new PlayerSeason(p1, s1); PlayerSeason ps2 = new
	 * PlayerSeason(p2, s1);
	 * 
	 * // adding all properties of PlayerSeason ps1.setPlayerSeasonProperties(300,
	 * 0, 130.45f, 5); ps2.setPlayerSeasonProperties(400, 2, 135.45f, 6);
	 * 
	 * // creating list of PlayerSeason List<PlayerSeason> psList = new
	 * ArrayList<PlayerSeason>();
	 * 
	 * // Adding PlayerSeason objects in list psList.add(ps1); psList.add(ps2);
	 * 
	 * // adding list of playerSeason in seasons s2.setSeasonPlayers(psList);
	 * s1.setSeasonPlayers(psList);
	 * 
	 * System.out.println("Players are added in Season");
	 * 
	 * //// adding Matches in Season Objects - for that Creating Match Objects Match
	 * match1 = new Match(1, s1, "Mumbai"); Match match2 = new Match(2, s1,
	 * "Banglore");
	 * 
	 * // Creating TeamMatch objects for adding teams which are playing in this
	 * matches Team team1 = new Team(1, "CSK", "India Cements"); Team team2 = new
	 * Team(2, "MI", "Reliance"); Team team3 = new Team(3, "RCB", "RRR");
	 * 
	 * TeamMatch teamMatch1 = new TeamMatch(team1, team2, match1); TeamMatch
	 * teamMatch2 = new TeamMatch(team1, team3, match2);
	 * 
	 * // add teams in Match match1.setTeamsPlayingInThisMatch(teamMatch1);
	 * match2.setTeamsPlayingInThisMatch(teamMatch2);
	 * 
	 * // Adding Awards in Match - for the we need to add award objects list in the
	 * // match Award award1 = new Award(1, "Man Of The Match", match1); Award
	 * award2 = new Award(2, "SuperStriker", match1); Award award3 = new Award(3,
	 * "Man Of The Match", match2); Award award4 = new Award(4, "SuperStriker",
	 * match2);
	 * 
	 * // Adding other Properties Of Award award1.setWinner(p1);
	 * award2.setWinner(p1); award3.setWinner(p2); award4.setWinner(p2);
	 * 
	 * // Creating List of Awards for match 1 List<Award> awardList1 = new
	 * ArrayList<Award>();
	 * 
	 * // creating list for awards for match2 List<Award> awardList2 = new
	 * ArrayList<Award>();
	 * 
	 * // add awards in awardList 1 awardList1.add(award1); awardList1.add(award2);
	 * 
	 * // add awards in awardsList 2 awardList2.add(award3); awardList2.add(award4);
	 * 
	 * // adding awardList in match match1.setAwards(awardList1);
	 * match2.setAwards(awardList2); // Creating list of matches List<Match>
	 * matchList = new ArrayList<Match>();
	 * 
	 * // adding matches in list matchList.add(match1); matchList.add(match2);
	 * 
	 * // Adding Matches in season s1.setMatches(matchList);
	 * s2.setMatches(matchList);
	 * 
	 * System.out.println("Matches are added in Season");
	 * 
	 * // Adding Teams in season for that creating TeamSeason objects TeamSeason
	 * teamSeason1 = new TeamSeason(team1, s1); TeamSeason teamSeason2 = new
	 * TeamSeason(team2, s1);
	 * 
	 * // Adding other properties of for TeamSeason object
	 * teamSeason1.setTeamSeasonProperties(p1, "Champion", p1, p1);
	 * teamSeason1.setTeamSeasonProperties(p2, "Runner up", p2, p3);
	 * 
	 * // Creating TeamSeason list List<TeamSeason> teamSeasonList = new
	 * ArrayList<TeamSeason>();
	 * 
	 * // Adding TeamSeason Objects in list teamSeasonList.add(teamSeason1);
	 * teamSeasonList.add(teamSeason2);
	 * 
	 * // Adding teamSeason in Season Object s1.setSeasonTeams(teamSeasonList);
	 * s2.setSeasonTeams(teamSeasonList);
	 * 
	 * System.out.println("Teams are added in Season");
	 * 
	 * listOfSeasons.add(s1); listOfSeasons.add(s2); listOfSeasons.add(s3);
	 * 
	 * System.out.println("Size of the Season Database is :" +
	 * listOfSeasons.size()); System.out.println("Created Database Succesfully...");
	 * }
	 * 
	 */
	@Override
